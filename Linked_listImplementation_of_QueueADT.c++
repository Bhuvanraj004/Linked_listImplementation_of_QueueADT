...
{
node *head; int front,rare; public: queue()
{
front=-1; rare=-1;
}
...
{
head =new node;
head->next=NULL; head->data=x; rare ++;
}
else
{
...
main()
{
Clrscr(); queue s1; int ch; while(1)
{
